  ...
  <div class="col-md-12">
    <div class="panel panel-default">
      <div class="panel-heading font-bold">
        <div class="row">
          <div class="col-md-10">
            <p class="m-n font-thin h3 text-primary"><i class="fa fa-pencil-square-o"></i>&nbspEdit New Currency </p>
          </div>
          <div class="col-md-2">
      ...
      <div class="panel-body">
        @if ($errors->any())
          ...
          @endif
          <form class="well form-horizontal" action="{{ route('currency.update', $cur->id) }}" method="post" enctype="multipart/form-data">
            @csrf
                  ...
                  <label class="col-md-4 control-label">{{ 'Name' }} <span style="color:red;">*</span></label>
                   <div class="col-md-8 inputGroupContainer">
                      <div class="input-group"><span class="input-group-addon"><i class="fa fa-suitcase"></i></span>
                        <input value="{{ $cur->name }}" name="name" placeholder="Currency Title" class="form-control" required="true" value="" type="text">
                      </div>
                   </div>
                </div>
                <div class="form-group">
                  <label class="col-md-4 control-label">{{ 'Code' }} <span style="color:red;">*</span></label>
                   <div class="col-md-8 inputGroupContainer">
                      <div class="input-group"><span class="input-group-addon"><i class="fa fa-book"></i></span>
                        <input value="{{ $cur->code }}" name="code" placeholder="BDT/INR..." class="form-control" required="true" value="" type="text">
                      </div>
                   </div>
                </div>
                <div class="form-group">
                  <label class="col-md-4 control-label">{{ 'Symbol' }} <span style="color:red;">*</span></label>
                   <div class="col-md-8 inputGroupContainer">
                      <div class="input-group"><span class="input-group-addon"><i class="fa fa-comments"></i></span>
                        <input value="{{ $cur->symbol }}" name="symbol" placeholder="$" class="form-control" required="true" value="" type="text">
                      </div>
                   </div>
                </div>
              </div>
                  ...
                  <label class="col-md-4 control-label">{{ 'Exchange Rate (BDT)' }} <span style="color:red;">*</span></label>
                   <div class="col-md-8 inputGroupContainer">
                      <div class="input-group"><span class="input-group-addon"><i class="fa fa-usd"></i></span>
                        <input value="{{ $cur->rate }}" name="rate" placeholder="100" class="form-control" required="true" value="" type="number"></div>
                   </div>
                </div>
                <div class="form-group">
                  <label class="col-md-4 control-label">{{ 'Notes' }} <span style="color:red;">*</span></label>
                   <div class="col-md-8 inputGroupContainer">
                      <div class="input-group"><span class="input-group-addon"><i class="fa fa-plus-square"></i></span>
                        <input value="{{ $cur->note }}" name="note" class="form-control" required="true" value="" type="text"></div>
                   </div>
                </div>
              </div>
            </div>
