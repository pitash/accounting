  ...
  <div class="col-md-12">
    <div class="panel panel-default">
      <div class="panel-heading font-bold">
        <div class="row">
          <div class="col-md-10">
            <p class="m-n font-thin h3 text-primary"><i class="fa fa-tags"></i>&nbspCreate New Company </p>
          </div>
          <div class="col-md-2">
      ...
      <div class="panel-body">
        @if ($errors->any())
          ...
          @endif
          <form class="well form-horizontal" action="{{ route('company.store') }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row">
              <div class="col-sm-5">
                <legend></legend>
                  ...
                  <label class="col-md-4 control-label">{{ 'Name' }} <span style="color:red;">*</span></label>
                   <div class="col-md-8 inputGroupContainer">
                      <div class="input-group"><span class="input-group-addon"><i class="fa fa-suitcase"></i></span>
                        <input name="company" placeholder="Company Name" class="form-control" required="true" value="{{ old('company') }}" type="text">
                      </div>
                   </div>
                </div>
                <div class="form-group">
                  <label class="col-md-4 control-label">{{ 'Financial Year From' }} <span style="color:red;">*</span></label>
                   <div class="col-md-8 inputGroupContainer">
                      <div class="input-group"><span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                        <input  name="start_date"  class="form-control" required="true" value="{{ old('start_date') }}" type="date">
                      </div>
                   </div>
                </div>
                <div class="form-group">
                  ...
                  <label class="col-md-4 control-label">{{ 'Website' }} <span style="color:red;">*</span></label>
                   <div class="col-md-8 inputGroupContainer">
                      <div class="input-group"><span class="input-group-addon"><i class="fa fa-globe"></i></span>
                        <input name="website" placeholder="www.test.com" class="form-control" required="true" value="{{ old('website') }}" type="text"></div>
                   </div>
                </div>
              </div>
              <div class="col-sm-5">
                <legend></legend>
                <div class="form-group">
                  <label class="col-md-4 control-label">{{ 'Com ID' }} <span style="color:red;">*</span></label>
                   <div class="col-md-8 inputGroupContainer">
                      <div class="input-group"><span class="input-group-addon"><i class="fa fa-plus-square"></i></span>
                        <input name="comp_id" placeholder="Company ID" class="form-control" required="true" value="{{ old('note') }}" type="text"></div>
                   </div>
                </div>
                <div class="form-group">
                  <label class="col-md-4 control-label">{{ 'Financial Year To' }} <span style="color:red;">*</span></label>
                   <div class="col-md-8 inputGroupContainer">
                      <div class="input-group"><span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                        <input name="end_date" class="form-control" required="true" value="{{ old('end_date') }}" type="date"></div>
                   </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label class="col-md-4 control-label">{{ 'Comp Logo' }} <span style="color:red;">*</span></label>
                   <div class="col-md-8 inputGroupContainer">
                      <div class="input-group"><span class="input-group-addon"><i class="fa fa-plus-square"></i></span>
                        <input name="comp_logo" class="form-control" value="{{ old('comp_logo') }}" type="file"></div>
                   </div>
                </div>
              </div>
            </div>
