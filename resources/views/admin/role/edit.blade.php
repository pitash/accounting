                ...
                <div class="panel-heading font-bold">
                    ...
                    <div class="panel-body">
                        <div class="col-md-8 col-md-offset-2">
                            <form class="bs-example form-horizontal" action="{{ route('role.update',$item->id) }}" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" name="role_name"  value="{{$item->role_name}}"  placeholder="Provide Role Name"  type="text"   required>
